...
namespace Samody\PostmanGenerator\Tests;

use Samody\PostmanGenerator\Tests\Fixtures\AuditLogController;
use Samody\PostmanGenerator\Tests\Fixtures\ExampleController;

class TestCase extends \Orchestra\Testbench\TestCase
{
    protected function getPackageProviders($app)
    {
        return ['Samody\PostmanGenerator\PostmanGeneratorServiceProvider'];
    }
